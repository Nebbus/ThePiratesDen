...
public class EDI_Condition : Editor
{
    ...
    private SOBJ_Condition     condition;               // Reference to the target.
    ...
    private void InteractableGUI()
    {
         ...
         */
        conditionIndex = EditorGUILayout.Popup(conditionIndex, EDI_AllConditions.AllConditionDescriptions,
            GUILayout.Width(width));

        // Find the equivalent condition in the AllConditions array.
        SOBJ_Condition globalCondition = EDI_AllConditions.TryGetConditionAt(conditionIndex);
    ...
    /// </summary>
    /// <returns></returns>
    public static SOBJ_Condition CreateCondition()
    {
         ...
         */ 
        SOBJ_Condition globalCondition = EDI_AllConditions.TryGetConditionAt(0);
    ...
    public static SOBJ_Condition CreateCondition(string description)
    {
    ...
    private static void SetHash(SOBJ_Condition condition)
    {
