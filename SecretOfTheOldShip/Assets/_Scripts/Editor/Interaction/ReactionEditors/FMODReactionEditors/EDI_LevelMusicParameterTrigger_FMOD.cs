   ...
   // private SOBJ_LevelMusicParameterTrigger_FMOD targetScript ;
    ...
    protected override void Init()
    {
       // targetScript = (SOBJ_LevelMusicParameterTrigger_FMOD)target;
        ...
        for (int i = 0; i < musicEmiterProperty.arraySize; i++)
        {
            ...
            {
                musicTargetEmitter = SOBJ_LevelMusicAmbientEmitters.Instance.getMusicTarget;
        ...
        for (int i = 0; i < ambienceEmiterProperty.arraySize; i++)
        {
            ...
            {
                ambientargetEmitter = SOBJ_LevelMusicAmbientEmitters.Instance.getAmbienceTarget;
    ...
    protected override void DrawReaction()
    {
       ...
       // base.DrawReaction();
        ...
        DrawAmbientGUI(ref ambientargetEmitter, ref ambienceEmiterProperty, ref abientExpanded, SOBJ_LevelMusicAmbientEmitters.Instance.getAmbienceTarget);
        EditorGUI.indentLevel--;
        ...
        EditorGUILayout.BeginVertical(GUI.skin.box);
        EditorGUI.indentLevel++;
        DrawAmbientGUI(ref musicTargetEmitter, ref musicEmiterProperty, ref musicExpanded, SOBJ_LevelMusicAmbientEmitters.Instance.getMusicTarget);
        EditorGUI.indentLevel--;
        EditorGUILayout.EndVertical();
    }
