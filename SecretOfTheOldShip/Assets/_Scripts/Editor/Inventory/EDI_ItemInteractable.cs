...
public class EDI_ItemInteractable : Editor
{
    ...
    public EDI_Item paranteEditor;                         // Referens to the parent so this can be removed
    public EDI_Item.CurentInteractions type;               // if this is hover or click interactable so this can be removed
